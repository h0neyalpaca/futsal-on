...
<link rel="stylesheet" type="text/css" href="${request.contextPath}/resources/css/matching/matching-team-modify.css" />
		...
		<div class="section">
			<div class="new-match-wrap">
				<div class="sub-nav-wrap">
					<div class="sub-nav">
						<a href=""><i class="fas fa-users"></i>팀매칭수정</a>
					</div>
				</div>
				<div class="search-wrap">									
					<form onsubmit="return formCheck();"action="/matching/team/team-modify-register" method="post">
						<dl>
							<dt>경기지역</dt>
...
let cancel = () => {
	if (window.confirm("정말로 삭제 하시겠습니까?")) {
		location.href="/matching/team/team-modify-register?matchIdx=${matchIdx}&modify=삭제";
	}else{
		return false;
	}
}
