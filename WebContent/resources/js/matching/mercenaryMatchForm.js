let formCheck = () => {
	...
	if(pay == ""){
		...
		document.querySelector('#checkMatchPay').innerHTML = '<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;용병비를 입력하세요.';	
		return false;	
	}
	
	let mercenary = document.querySelector("#mercenary").value;
	
	if(mercenary == ""){
		document.querySelector('#checkMercenary').style.color = 'red';
		document.querySelector('#checkMercenary').innerHTML = '<br>&nbsp;&nbsp;&nbsp;모집인원를 입력하세요.';	
		return false;	
	}
